        ...
        <div className="container max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex space-x-6">
              <a href="https://www.linkedin.com/in/mohammed-haji9991" className="text-muted-foreground hover:text-foreground transition-colors">
              ...
              <a href="https://github.com/MOHAJII" className="text-muted-foreground hover:text-foreground transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
